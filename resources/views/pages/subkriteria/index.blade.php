                ...
                <table class="table table-striped border">
                    ...
                    @foreach ($subkriterias as $index => $subkriteria)
                        <tr class="text-center">
                            ...
                            <td>
                                <span class="badge text-white text-bg-warning edit-link" data-bs-toggle="modal" data-bs-target="#exampleModal3" data-id="{{ $subkriteria->id }}" data-idNama="{{$subkriteria->nama_subkriteria}}">
                                    Edit
                                </span> | 
                                <span class="badge text-white text-bg-danger delete-link" data-bs-toggle="modal" data-bs-target="#exampleModal2" data-id="{{ $subkriteria->id }}">
                                    Delete
                                </span>
                            </td>
                        </tr>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control border px-2" id="nama_subkriteria" name="nama_subkriteria">
                            </div>
                        </div>
